...
```bash
origin  https://github.com/[yourUserName]/auro-select.git (fetch)
origin  https://github.com/[yourUserName]/auro-select.git (push)
```

To add the upstream repo to your local forked project

```bash
$ git remote add upstream https://github.com/AlaskaAirlines/auro-select.git
```
...
origin  https://github.com/[yourUserName]/auro-select.git (fetch)
origin  https://github.com/[yourUserName]/auro-select.git (push)
upstream        https://github.com/AlaskaAirlines/auro-select.git (fetch)
upstream        https://github.com/AlaskaAirlines/auro-select.git (push)
```
