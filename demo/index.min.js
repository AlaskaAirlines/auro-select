...
var tokensCss = css`:host{--ds-auro-select-placeholder-text-color: var(--ds-color-text-secondary-default, $ds-color-text-secondary-default)}`;
...
class AuroSelect extends LitElement {
  ...
  updateDisplayedValue(option) {
    ...
    // this.runtimeUtils.closestElement('auro-menuoption', triggerContentEl)
